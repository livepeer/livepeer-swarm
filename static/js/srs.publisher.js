...
function SrsPublisher(container, width, height, private_object) {
    ...
    // error code defines.
    this.errors = {
        "100": "Cannot access camera", //error_camera_get 
        "101": "Cannot access mic", //error_microphone_get 
        "102": "Please give flash the proper permissions to access your webcam.", //error_camera_muted 
        "103": "Server closed connection.", //error_connection_closed 
        "104": "Server connection failure.", //error_connection_failed 
        "199": "Unknow Error"
    };
}
/**
